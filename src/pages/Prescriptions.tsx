...
import { getPrescriptions, doctors, type Prescription } from "@/lib/data";
...
const Prescriptions = () => {
  ...
  const search = () => {
    ...
    setResults(all.filter((p) => p.patientPhone === phone));
  };
    ...
    <div className="min-h-screen pt-24 pb-20 bg-background">
      <div className="container mx-auto px-4 max-w-xl">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-10">
          ...
          <p className="text-muted-foreground">Enter your registered mobile number to view digital prescriptions.</p>
        </motion.div>
                    ...
                    return (
                      ...
                      >
                        <div className="flex justify-between items-start mb-4">
                          ...
                          <span className="text-3xl text-primary font-heading font-bold">℞</span>
                        </div>
